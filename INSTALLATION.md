...
- It is required to have **Matlab Version R2023b** (tested). If you use a different version, please check the compatibility of the Simulink model with the 2023b version. The final evaluation will be carried out with Matlab R2023b.
